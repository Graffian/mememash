    ...
    <>
      <div className={styles.landingPage}>
        ...
        <div className={styles.appDescription}>
          <h3>How it works</h3>
          <p>
            Join the ultimate meme battle arena! Post your funniest memes and
            watch them compete against others. When users choose your meme over
            another, your ELO rating goes up. Climb the leaderboard and become
            the meme champion!
          </p>
        </div>
